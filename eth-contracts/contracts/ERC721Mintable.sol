...
contract Ownable {
    ...
    modifier isOwner(address a, address ownable_owner)
    {
        require(a == ownable_owner, "Address is not owner of the ownable");
        _;
    }
...
contract ERC721 is Pausable, ERC165 {
    ...
    function approve(address to, uint256 tokenId) public 
        ...
        require(to != owner, "Owner is already approved");

        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(owner == msg.sender || isApprovedForAll(owner, msg.sender), "Owner of token is not the sender and sender is not approved for operation");
...
contract ERC721Enumerable is ERC165, ERC721 {
    ...
    function _removeTokenFromOwnerEnumeration(address from, uint256 tokenId) private {
        ...
        // https://stackoverflow.com/questions/66617876/member-sub-not-found-or-not-visible-after-argument-dependent-lookup-in-tuple
        ...
        // https://ethereum.stackexchange.com/questions/80743/how-to-reset-the-length-of-array-in-solidity-v6-0
